...
{
    rtcio_ll_enable_input_in_sleep(gpio_num);
}

static inline void rtcio_ll_in_sleep_disable_input(gpio_num_t gpio_num)
{
    rtcio_ll_disable_input_in_sleep(gpio_num);
}

static inline void rtcio_ll_in_sleep_enable_output(gpio_num_t gpio_num)
{
    rtcio_ll_enable_output_in_sleep(gpio_num);
}

static inline void rtcio_ll_in_sleep_disable_output(gpio_num_t gpio_num)
{
    rtcio_ll_disable_output_in_sleep(gpio_num);
}
